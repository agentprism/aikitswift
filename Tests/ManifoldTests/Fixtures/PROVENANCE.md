...
| Set | Upstream path | Streams | Response bodies |
|---|---|---|---|
| `anthropic` | `packages/anthropic/src` | 27 | 32 |
| `openai-completions` | `packages/openai/src/chat` | 2 | 2 |
| `openai-responses` | `packages/openai/src/responses` | 29 | 29 |
| `google` | `packages/google/src` | 20 | 16 |
| `deepseek` | `packages/deepseek/src` | 3 | 4 |
| `xai` | `packages/xai/src` | 7 | 6 |
| `groq` | `packages/groq/src` | 3 | 3 |
| `mistral` | `packages/mistral/src` | 3 | 4 |
| `cerebras` | `packages/cerebras/src` | 1 | 0 |
| `openai-compatible` | `packages/openai-compatible/src` | 2 | 2 |
