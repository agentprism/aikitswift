...
3. Prompt Codex and print normalized text deltas as they stream.
4. Append `response.assistantMessage`, switch the destination to Claude, and continue streaming the same conversation.
...
conversation.append(.user("Is that calculation correct?"))
